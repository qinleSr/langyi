  ...
  <div class="CustmerBox">
    <div class="CustmerBox_Head">
      ...
      <div class="cards">
          ...
          <MotherLog :tableData="tableData" :tableLabel="tableLabel" :config="config">
<template v-slot:edit>
    ...
    <el-row>
      ...
      <el-col>
         <div class="col_items">
          ...
          <el-date-picker v-model="form.birth_time" type="date" placeholder="选择日期"></el-date-picker>
        </div>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      ...
      <el-col>
         <div class="col_items">
          ...
          <el-date-picker v-model="form.production_time" type="date" placeholder="选择日期"></el-date-picker>
        </div>
      </el-col>
    </el-row>
    <el-row>
      <el-col>
        <div class="col_items">
          ...
          <el-date-picker v-model="form.leave_time" type="date" placeholder="选择日期"></el-date-picker>
        </div>
      </el-col>
      <el-col>
         <div class="col_items">
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="FormMomlog = false">确 定</el-button>
  </div>
</el-dialog>
<!-- 生活日志编辑 -->
 <el-dialog title="生活日志" :visible.sync="FormEditMomlog">
  <el-form :model="form2">
    <el-row>
      ...
      <el-col>
         ...
         <el-date-picker v-model="form2.date" type="date" placeholder="选择日期"></el-date-picker>
        </div>
      </el-col>
      <el-col>
         <div class="col_items">
          ...
          <el-row>
            <el-input v-model="form2.s_time" autocomplete="off" width="50"></el-input>
            <span>:</span>
            <el-input v-model="form2.e_time" autocomplete="off" width="50"></el-input>
          </el-row>
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="FormEditMomlog = false">确 定</el-button>
  </div>
</el-dialog>
<!-- 查看妈妈日志 -->
<el-dialog
  title="妈妈日志"
  :visible.sync="dialogmomLog"
  width="70%"
  >
  <el-row>
    <el-col>
  ...
  <el-row>
    <el-col>
       <div class="col_items">
          ...
          <el-date-picker v-model="customer_birthdate" type="date" placeholder="选择日期"></el-date-picker>
        </div>
    </el-col>
    <el-col>
       <div class="col_items">
          <div class="head_items">
           ...
           <el-date-picker v-model="customer_todate" type="date" placeholder="选择日期"></el-date-picker>
        </div>
    </el-col>
    <el-col>
       <div class="col_items">
          ...
          <el-date-picker v-model="customer_productionDate" type="date" placeholder="选择日期"></el-date-picker>
        </div>
    </el-col>
    <el-col>
       <div class="col_items">
          <div class="head_items">
           ...
           <el-date-picker v-model="customer_leaveDte" type="date" placeholder="选择日期"></el-date-picker>
        </div>
    </el-col>
    <el-col>
       <div class="col_items">
  ...
  <el-table
    ...
    <el-table-column
     ...
     <el-table-column
      prop="tabel_department"
      label="部门">
    </el-table-column>
     <el-table-column
      prop="tabel_isSuccess"
      label="是否完成">
    </el-table-column>
     <el-table-column
      prop="tabel_note"
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="dialogmomLog = false">确 定</el-button>
  </span>
</el-dialog>
  </div>
</template>
...
.col_items .el-input,.el-select,.el-date-picker{
width: 180px;
}
