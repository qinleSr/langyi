  ...
  <el-form :model="form">
    <el-row>
      <el-col>
        ...
        <el-date-picker v-model="form.return_time" type="date" value-format="yyyy-MM-dd" placeholder="选择日期"></el-date-picker>
      </el-col>
      <el-col>
        <div class="label_title">
          <span class="improtant">*</span>
    ...
    <el-row>
      <el-col>
        ...
        <el-date-picker v-model="form.birth_time" type="date" value-format="yyyy-MM-dd" placeholder="选择日期"></el-date-picker>
      </el-col>
      <el-col>
        <div class="label_title">
          <span class="improtant">*</span>
    ...
    <el-row>
      <el-col>
        ...
        <el-input v-model="form.effect" autocomplete="off" style="width: 430px;"></el-input>
      </el-col>
      <el-col>
        <div class="label_title">
          <span class="improtant">*</span>
        ...
        <el-input v-model="form.note" autocomplete="off" style="width: 430px;"></el-input>
      </el-col>
    </el-row>
  </el-form>
