              ...
              <el-table-column label="单价(元)">
                <template slot-scope="scope">
                  <input
                    class="tableinput"
                    type="number"
                    v-model="scope.unit_price"
                    placeholder="请输入单价"
                    @blur="bbb(scope.$index, scope.unit_price)"
                  />
                </template>
              </el-table-column>
              ...
              <el-table-column label="备注">
                <template slot-scope="scope">
                  <input
                    ...
                    v-model="scope.note"
                    placeholder="备注"
                    @blur="ccc(scope.$index, scope.note)"
                  />
                </template>
              </el-table-column>
...
import { checkroomList } from "../../api/contract/preparation";
export default {
  name: "customer",
