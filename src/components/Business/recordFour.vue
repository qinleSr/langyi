  ...
  <el-form :model="form">
      ...
      <el-row>
         <el-col>
              ...
              <el-input v-model="form.project" autocomplete="off" style="width:500px"></el-input>
          </el-col>  
      </el-row>
      <el-row>
          <el-col>
              ...
              <el-input v-model="form.number_of" autocomplete="off"></el-input>
          </el-col>
          <el-col>
              <div class="label_title">
                  <span class="improtant">*</span>
              ...
              <el-input v-model="form.monitoring_date" autocomplete="off"></el-input>
          </el-col>
          <el-col>
              <div class="label_title">
                  <span class="improtant">*</span>
      ...
      <el-row>
          <el-col>
              ...
              <el-input v-model="form.note" autocomplete="off" style="width:500px"></el-input>
          </el-col>
